...
const CACHE = "morgen-briefing-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./app.js",
...
self.addEventListener("fetch", (event) => {
  ...
  // API-Aufrufe (Anthropic, TomTom, Open-Meteo) niemals cachen – immer Netzwerk.
  const isApi = /api\.anthropic\.com|api\.tomtom\.com|open-meteo\.com/.test(url.host);
